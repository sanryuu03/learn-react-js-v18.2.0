            ...
            <div className='bg-slate-100 text-slate-800 tracking-tight antialiased flex items-center justify-center min-h-screen'>
                <div className='max-w-md w-full'>
                    <Card>
                        ...
                        <Card.Body>
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime omnis hic ducimus. Ullam, harum molestias? Sequi minus,
                            nemo ex vel modi, eaque molestias saepe eligendi facere non eos autem consequuntur.
                        </Card.Body>
